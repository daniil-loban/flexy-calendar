...
export const API_GET_MONTH = 5
export const API_SET_MONTH = 6
export const API_GET_YEAR = 7
export const API_SET_YEAR = 8
export const API_SHOW_PREV_MONTH = 9
export const API_SHOW_NEXT_MONTH = 10